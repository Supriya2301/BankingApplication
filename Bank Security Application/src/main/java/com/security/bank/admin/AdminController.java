...
/**
 * This controller controls admin related APIs such as registering admin and access all APIs an admin is authoirzed to.
 * This will delegate the API call to user service layer.
 */
